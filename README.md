...
一款基于 Minecraft 10 风格的像素字体，支持完整的 Unicode 字符集。

## 项目特点
- **Minecraft 10 风格**：核心拉丁字母、数字及基础符号基于经典的 Minecraft 10 字体。
- **全 Unicode 支持**：通过集成 GNU Unifont，支持包括中文、日韩文、特殊符号在内的数万个 Unicode 字符。
- **物理加粗优化**：补充的 Unicode 字符经过物理字形平移合并处理，使其视觉权重与 Minecraft 10 的厚重风格完美匹配。
...
- 建议仅用于个人学习、研究或非商业用途。
- 引用资源请遵循原作者的许可协议（如 CC-BY 4.0 或 GNU GPL）。
